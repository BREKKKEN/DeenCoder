...
|_____/  |______| |______| |_| \_|  \_____|  \____/  |_____/  |______| |_|  \_\ [v0.2.1]
==============================================================================================================================""")
...
def main():
    while True:
        ...
        print("")
        print('DeenCoder - Please choose 1/2/3/4/5 or type "?e" for extra commands - Please note that DeenCoder is still in the beta stages!')
...
typing res or reset will clear the screen/console

typing re1 will re-print your latest morse to english translation

typing re2 will re-print your latest english to morse translation

typing ?e will print all extra commands
...
DeenCoder Github - https://github.com/BREKKKEN/DeenCoder""")
            ...
            m = """Extra commands:
"re1"  will re-print your latest morse to english translation

"re2"  will re-print your latest english to morse translation

"res" or "reset"  will clear the screen/console"""
            print(Fore.GREEN + '')
            print(m)
            print(Fore.WHITE, '')
